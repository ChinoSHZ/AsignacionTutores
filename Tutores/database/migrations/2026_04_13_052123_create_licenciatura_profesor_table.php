...
return new class extends Migration
{
    ...
    {
        // 1. Eliminamos la columna de la relación anterior si existe
        Schema::table('profesores', function (Blueprint $table) {
            // Se asume que la migración anterior agregó 'licenciatura_id'
    ...
    public function down(): void
    {
        ...
        // Restauramos la columna en caso de rollback
        Schema::table('profesores', function (Blueprint $table) {
            $table->foreignId('licenciatura_id')->nullable()->constrained('licenciaturas');
        });
    }
};